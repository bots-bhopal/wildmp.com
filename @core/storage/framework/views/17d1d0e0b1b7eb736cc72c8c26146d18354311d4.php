        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                        ...
                        <?php if(request()->is('admin-home/video-gallery/*')): ?> active <?php endif; ?>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="<?php echo e(active_menu('admin-home/video-gallery/page-settings')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.video.gallery.page.settings')); ?>"><?php echo e(__('Page Settings')); ?></a>
                                </li>
                            </ul>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <li class="main_dropdown
                    <?php if(request()->is(['admin-home/quote-manage/*', 'admin-home/package/*', 'admin-home/payment-logs', 'admin-home/payment-logs/report', 'admin-home/jobs', 'admin-home/jobs/*', 'admin-home/events', 'admin-home/events/*', 'admin-home/products', 'admin-home/products/*', 'admin-home/donations', 'admin-home/donations/*', 'admin-home/knowledge', 'admin-home/knowledge/*', 'admin-home/appointment/*', 'admin-home/courses/*', 'admin-home/support-tickets/*', 'admin-home/support-tickets'])): ?> active <?php endif; ?>">
                        ...
                        <ul class="collapse ">
                                ...
                                <li class="main_dropdown <?php if(request()->is('admin-home/courses/*')): ?> active <?php endif; ?> ">
                                    ...
                                    <ul class="collapse">
                                        <li class="<?php echo e(active_menu('admin-home/courses/all')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.all')); ?>"><?php echo e(__('All Courses')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/new')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.new')); ?>"><?php echo e(__('New Course')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/category')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.category.all')); ?>"><?php echo e(__('Category')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/lesson')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.lesson.all')); ?>"><?php echo e(__('All Lessons')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/review')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.review.all')); ?>"><?php echo e(__('All Reviews')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/coupon')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.coupon.all')); ?>"><?php echo e(__('Coupons')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/instructor')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.instructor.all')); ?>"><?php echo e(__('Instructor')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/enroll')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.enroll.all')); ?>"><?php echo e(__('All Enrollment')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/certificate')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.certificate.all')); ?>"><?php echo e(__('Certificate')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/courses/settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.courses.settings')); ?>"><?php echo e(__('Settings')); ?></a>
                                        </li>
                                    </ul>
                                </li>
                            <?php endif; ?>
                                ...
                                <li class="main_dropdown <?php if(request()->is('admin-home/appointment/*')): ?> active <?php endif; ?> ">
                                    ...
                                    <ul class="collapse">
                                        <li class="<?php echo e(active_menu('admin-home/appointment/all')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.appointment.all')); ?>"><?php echo e(__('All appointment')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/appointment/new')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.appointment.new')); ?>"><?php echo e(__('New Appointment')); ?></a>
                                        </li>
                            ...
                            <?php if(check_page_permission_by_string('Package Orders Manage')): ?>
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li
                                            class="<?php echo e(active_menu('admin-home/package/order-manage/in-progress')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.package.order.manage.in.progress')); ?>"><?php echo e(__('In Progress Order')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/package/order-manage/completed')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.package.order.manage.completed')); ?>"><?php echo e(__('Completed Order')); ?></a>
                                        </li>
                                        <li
                                            class="<?php echo e(active_menu('admin-home/package/order-manage/success-page')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.package.order.success.page')); ?>"><?php echo e(__('Success Order Page')); ?></a>
                                        </li>
                                        <li
                                            class="<?php echo e(active_menu('admin-home/package/order-manage/cancel-page')); ?>">
                                            <a
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/package/order-manage/settings')); ?>">
                                            <a
                                ...
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/new-jobs')); ?>"><a
                                                href="<?php echo e(route('admin.jobs.new')); ?>"><?php echo e(__('Add New Job')); ?></a>
                                        </li>
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/jobs/success-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.jobs.success.page.settings')); ?>"><?php echo e(__('Job Success Page Settings')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/jobs/cancel-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.jobs.cancel.page.settings')); ?>"><?php echo e(__('Job Cancel Page Settings')); ?></a>
                                        </li>
                                ...
                                <li
                                    ...
                                    <ul class="collapse">
                                        <li class="<?php echo e(active_menu('admin-home/events/all')); ?>"><a
                                                href="<?php echo e(route('admin.events.all')); ?>"><?php echo e(__('All Events')); ?></a>
                                        </li>
                                        ...
                                        <li
                                            class="<?php echo e(active_menu('admin-home/events/payment-success-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.events.payment.success.page.settings')); ?>"><?php echo e(__('Payment Success Page Settings')); ?></a>
                                        </li>
                                        <li
                                            class="<?php echo e(active_menu('admin-home/events/payment-cancel-pag-settings')); ?>">
                                            <a
                            ...
                            <?php if(check_page_permission_by_string('Products Manage') && !empty(get_static_option('product_module_status'))): ?>
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/products/single-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.products.single.page.settings')); ?>"><?php echo e(__('Product Single Page Settings')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/products/success-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.products.success.page.settings')); ?>"><?php echo e(__('Order Success Page Settings')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/products/cancel-page-settings')); ?>">
                                            <a
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/products/order-report')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.products.order.report')); ?>"><?php echo e(__('Order Report')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/products/tax-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.products.tax.settings')); ?>"><?php echo e(__('Tax Settings')); ?></a>
                                        </li>
                                        <li class="<?php echo e(active_menu('admin-home/products/settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.products.settings')); ?>"><?php echo e(__('Settings')); ?></a>
                                        </li>
                                    </ul>
                                </li>
                            <?php endif; ?>
                            <?php if(check_page_permission_by_string('Donations Manage') && !empty(get_static_option('donations_module_status'))): ?>
                                <li
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/donations/single-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.donations.single.page.settings')); ?>"><?php echo e(__('Donation Single Settings')); ?></a>
                                        </li>

                                        <li
                                            class="<?php echo e(active_menu('admin-home/donations/donations-payment-logs')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.donations.payment.logs')); ?>"><?php echo e(__('Donation Payment Logs')); ?></a>
                                        </li>
                                        <li
                                            class="<?php echo e(active_menu('admin-home/donations/payment-success-page-settings')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.donations.payment.success.page.settings')); ?>"><?php echo e(__('Payment Success Page Settings')); ?></a>
                                        </li>
                                        <li
                                            class="<?php echo e(active_menu('admin-home/donations/payment-cancel-pag-settings')); ?>">
                                            <a
                                        ...
                                        <li class="<?php echo e(active_menu('admin-home/donations/report')); ?>">
                                            <a
                                                href="<?php echo e(route('admin.donations.report')); ?>"><?php echo e(__('Donation Report')); ?></a>
                                        </li>
                                    </ul>
                                </li>
                            <?php endif; ?>
                            <?php if(check_page_permission_by_string('Knowledgebase') && !empty(get_static_option('knowledgebase_module_status'))): ?>
                                <li
                                    class="main_dropdown <?php echo e(active_menu('admin-home/knowledge')); ?> <?php if(request()->is('admin-home/knowledge/*')): ?> active <?php endif; ?>">
                                    <a href="javascript:void(0)" aria-expanded="true">
                            ...
                            <?php if(check_page_permission_by_string('Support Tickets') && !empty(get_static_option('support_ticket_module_status'))): ?>
                                <li
                                    class="main_dropdown <?php echo e(active_menu('admin-home/support-tickets')); ?> <?php if(request()->is('admin-home/support-tickets/*')): ?> active <?php endif; ?>">
                                    <a href="javascript:void(0)" aria-expanded="true">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <?php if(empty(get_static_option('home_page_page_builder_status'))): ?>
                                            <?php if(in_array($home_page_variant, ['01', '02', '03', '04'])): ?>
                                                ...
                                                <li class="<?php echo e(active_menu('admin-home/home-page-01/about-us')); ?>">
                                                    <a
                                                ...
                                                <?php endif; ?>
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-page-01/testimonial')); ?>">
                                                    <a
                                                        href="<?php echo e(route('admin.homeone.testimonial')); ?>"><?php echo e(__('Testimonial Area')); ?></a>
                                                </li>
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-page-01/price-plan')); ?>">
                                                    <a
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-page-01/latest-news')); ?>">
                                                    <a
                                            ...
                                            <?php if($home_page_variant == '05'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-05/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '06'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-06/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '08'): ?>
                                                ...
                                                <!-- Add New Custom Menu -->
                                                <li class="<?php echo e(active_menu('admin-home/home-08/event-area')); ?>">
                                                    <a href="<?php echo e(route('admin.home08.all.event.area')); ?>">
                                                ...
                                                <!-- Add New Custom Menu -->
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-15/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '09'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-09/team-member-area')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-09/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '10'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-10/appointment-area')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-10/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '11'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-11/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '12'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-12/appointment-area')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-12/case-study-area')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-12/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '13'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-13/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '14'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-14/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '16'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-16/appointment-area')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-16/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '17'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-17/featured-courses')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-17/all-courses-area')); ?>">
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-17/testimonial-area')); ?>">
                                            ...
                                            <?php if($home_page_variant == '18'): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-18/testimonial-area')); ?>">
                    ...
                    ">
                        ...
                        <ul class="collapse ">
                            ...
                            <?php if(check_page_permission_by_string('Home Variant')): ?>
                                ...
                                <li
                                    class="main_dropdown <?php echo e(active_menu('admin-home/appearance-setting/home-variant')); ?>">
...
<?php /**PATH C:\xampp\htdocs\wildmp.com\@core\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>