                        ...
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('admin.menu')); ?>"
                                    class="btn btn-primary btn-xs"><?php echo e(__('All Menus')); ?></a>
                            </div>
                        </div>
                        <form action="<?php echo e(route('admin.menu.update', $page_post->id)); ?>" id="menu_update_form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="lang" id="language" class="form-control">
                                            <?php $__currentLoopData = $all_languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option <?php if($lang->slug == $page_post->lang): ?> selected <?php endif; ?>
                                                ...
                                                <div class="card-header" id="page-list-items">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link" type="button" data-toggle="collapse"
                                                            data-target="#page-list-items-content" aria-expanded="true"
                                                ...
                                                <div id="page-list-items-content" class="collapse show"
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="page-list-ul">
                                                            <li data-ptype="custom" data-purl="@url"
                                                                data-pname="<?php echo e(__('Home')); ?>">
                                                ...
                                                <div class="card-header" id="custom-links">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link collapsed" type="button"
                                                            data-toggle="collapse" data-target="#custom-links-content"
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#add_custom_links', function(e) {
                ...
                draggAbleMenuWrap.append('<li class="dd-item" data-id="' + draggAbleMenuLength +
                    '" data-ptype="custom" data-purl="' + menuSlug + '" data-pname="' + menuName +
                    '">\n' +
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\wildmp.com\@core\resources\views/backend/pages/menu/menu-edit.blade.php ENDPATH**/ ?>