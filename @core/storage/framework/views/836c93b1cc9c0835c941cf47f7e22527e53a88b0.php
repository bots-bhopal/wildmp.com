    ...
    <?php if(preg_match('/(xgenious)/', url('/'))): ?>
        ...
        <div class="buy-now-wrap">
            <ul class="buy-list">
                ...
                <li><a target="_blank" href="https://1.envato.market/OXNPP"><i class="fas fa-shopping-cart"></i></a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\wildmp.com\@core\resources\views/frontend/partials/footer.blade.php ENDPATH**/ ?>