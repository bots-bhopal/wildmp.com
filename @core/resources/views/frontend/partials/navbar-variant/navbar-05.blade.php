                            ...
                            <ul class="construction-info-list">
                                @foreach ($all_icon_fields as $icon)
                                    <li class="construction-single-info-list-item">
                                        ...
                                        <div class="content">
                                            <span
                                                class="subtitle">{{ $all_title_fields[$loop->index] ?? '' }}</span>
                                            <h5 class="title">{{ $all_details_fields[$loop->index] ?? '' }}
                                            </h5>
                                        </div>
                                    </li>
                                @endforeach
                                    ...
                                    <li>
                                        ...
                                        <div class="btn-wrapper">
                                            <a href="{{ $custom_url }}" rel="canonical"
                                                @if (!empty(filter_static_option_value('navbar_button_custom_url_status', $global_static_field_data))) target="_blank" @endif
                                                class="boxed-btn reverse-color">{{ filter_static_option_value('navbar_' . $user_select_lang_slug . '_button_text', $global_static_field_data) }}</a>
                                        </div>
                                    </li>
                                @endif
                            </ul>
