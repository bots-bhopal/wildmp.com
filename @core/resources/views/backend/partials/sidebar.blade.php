        ...
        <div class="menu-inner">
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    @endif
                    <li class="main_dropdown
                    @if (request()->is(['admin-home/quote-manage/*', 'admin-home/package/*', 'admin-home/payment-logs', 'admin-home/payment-logs/report', 'admin-home/jobs', 'admin-home/jobs/*', 'admin-home/events', 'admin-home/events/*', 'admin-home/products', 'admin-home/products/*', 'admin-home/donations', 'admin-home/donations/*', 'admin-home/knowledge', 'admin-home/knowledge/*', 'admin-home/appointment/*', 'admin-home/courses/*', 'admin-home/support-tickets/*', 'admin-home/support-tickets'])) active @endif">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        @if (empty(get_static_option('home_page_page_builder_status')))
                                            ...
                                            @if ($home_page_variant == '08')
                                                ...
                                                <!-- Add New Custom Menu -->
                                                <li class="{{ active_menu('admin-home/home-08/event-area') }}">
                                                    <a href="{{ route('admin.home08.all.event.area') }}">
                                                        {{ __('Event Area') }}
                                                    </a>
                                                </li>
                                                <!-- ./ End new Custom Menu -->
